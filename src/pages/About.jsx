...
export default function About() {
  ...
  return <>
    ...
    <section className="section bg-surface-container-low"><div className="container-max"><div className="overflow-hidden rounded-xl bg-surface-container-lowest shadow-[0_18px_45px_rgba(41,35,33,.10)]"><div className="grid lg:grid-cols-[5fr_7fr]"><div className="relative min-h-[360px]"><img src={homepage.coach.image || '/assets/img/upload/Folder%20Upload%20All%20Mentor/Foto%20mentor/DSC00490.jpeg'} alt="Coach Dehan Mahardika" className="h-full w-full object-cover" /></div><div className="flex flex-col justify-center p-7 sm:p-10 lg:p-12"><p className="eyebrow">Mengenal Fasilitator</p><h2 className="section-title mt-4">Dehan Mahardika, M.Psi.</h2><p className="mt-2 text-sm text-cocoa">Certified Mindfulness Educator • Somatic Grounding Practitioner</p><div className="mt-6 rounded-lg bg-surface-container-low p-5"><p className="editorial-quote text-xl leading-snug text-cocoa">“Saya tidak di sini untuk memperbaiki Anda, karena Anda tidak rusak. Saya di sini untuk menemani Anda menemukan kembali jalan pulang ke diri sendiri.”</p></div><p className="mt-6 max-w-2xl leading-8 text-espresso/70">Setelah lebih dari sepuluh tahun mendampingi ratusan profesional, seniman, dan keluarga yang bergulat dengan kejenuhan (burnout) serta duka tak terucap, Dehan menyadari bahwa apa yang manusia butuhkan bukanlah nasehat klise, melainkan ruang berlabuh yang tenang dan aman.</p><p className="mt-4 max-w-2xl leading-8 text-espresso/70">Pendekatannya mengakar pada tradisi kehadiran hening (holding space) yang dipadukan dengan kesadaran somatik tubuh, membimbing setiap individu mendengarkan kembali bisikan intuisi mereka yang tertutup oleh gemuruh ekspektasi sosial.</p><div className="mt-7 flex flex-wrap gap-2"><span className="rounded-full bg-surface-container px-3 py-2 text-xs font-semibold text-cocoa">Integrative Mindfulness Practitioner</span><span className="rounded-full bg-surface-container px-3 py-2 text-xs font-semibold text-cocoa">Somatic Experiencing Facilitator</span><span className="rounded-full bg-surface-container px-3 py-2 text-xs font-semibold text-cocoa">1,400+ Jam Sesi Reflektif</span></div></div></div></div></div></section>
